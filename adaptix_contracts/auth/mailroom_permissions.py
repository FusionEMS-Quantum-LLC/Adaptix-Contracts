...
_ROLE_PERMISSION_GRANTS: tuple[tuple[frozenset[str], frozenset[str]], ...] = (
    (_ADMIN_ROLES, frozenset(MAILROOM_PERMISSIONS)),
    (
        _BILLING_ROLES,
        frozenset(
...
def mailroom_permissions_for_roles(
    ...
    *,
    ...
    granted: set[str] = set()
    for role_set, permissions in _ROLE_PERMISSION_GRANTS:

...
`Adaptix-Contracts` owns: Contracts.

## Boundary law

- Own only the truth explicitly assigned to this repository and its local
  subsystem agents.
...
The governance runtime denies new private cross-domain imports and logs the
blocked action.
